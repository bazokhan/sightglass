...
Install `@bazokhan/sightglass-core` and configure it once at application startup. See the [Express guide](https://sightglass-docs.trugraph.io/docs/frameworks#express).
